    ...
    trs.forEach(function (tr, i) {
        ...
        if (testhere$) {
            if (testhere[0].innerHTML.toUpperCase().indexOf(filters[0]) > -1 &&
                ...
                testhere[3].innerHTML.toUpperCase().indexOf(filters[3]) > -1 &&
                testhere[4].innerHTML.toUpperCase().indexOf(filters[4]) > -1 &&
                testhere[5].innerHTML.toUpperCase().indexOf(filters[5]) > -1 &&
                testhere[6].innerHTML.toUpperCase().indexOf(filters[6]) > -1 &&
                testhere[7].innerHTML.toUpperCase().indexOf(filters[7]) > -1 &&
                testhere[8].innerHTML.toUpperCase().indexOf(filters[8]) > -1 &&
                testhere[9].innerHTML.toUpperCase().indexOf(filters[9]) > -1 &&
                testhere[10].innerHTML.toUpperCase().indexOf(filters[10]) > -1 &&
